        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageCouse = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Creatorld = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Code = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Price = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    TotalCourseDuration = table.Column<int>(type: "int", nullable: true),
                    NumberOfStudent = table.Column<int>(type: "int", nullable: true),
                    NumberOfPurchases = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActivce = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MakeQuestion", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MakeQuestion_SubjectDetail_SubjectDetailId",
                        column: x => x.SubjectDetailId,
                        principalTable: "SubjectDetail",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Practice_SubjectDetail_SubjectDetailId",
                        column: x => x.SubjectDetailId,
                        principalTable: "SubjectDetail",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_User_Districts_DistrictId",
                        column: x => x.DistrictId,
                        principalTable: "Districts",
                        principalColumn: "Id");
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_User_Provinces_ProvinceId",
                        column: x => x.ProvinceId,
                        principalTable: "Provinces",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_User_Wards_WardId",
                        column: x => x.WardId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Answers_MakeQuestion_QuestionId",
                        column: x => x.QuestionId,
                        principalTable: "MakeQuestion",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ConfirmEmails_User_UserId",
                        column: x => x.UserId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RegisterStudies_User_UserId",
                        column: x => x.UserId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CerificateTypes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CerificateTypes_Certificates_CertificateId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LearningProgres", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LearningProgres_RegisterStudies_RegisterStudyId",
                        column: x => x.RegisterStudyId,
                        principalTable: "RegisterStudies",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_LearningProgres_Subjects_SubjectId",
                        column: x => x.SubjectId,
                        principalTable: "Subjects",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_LearningProgres_User_UserId",
                        column: x => x.UserId,
                        principalTable: "User",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bill_CourseId",
                table: "Bill",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_CerificateTypes_CertificateId",
                table: "CerificateTypes",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LearningProgres_RegisterStudyId",
                table: "LearningProgres",
                column: "RegisterStudyId");

            migrationBuilder.CreateIndex(
                name: "IX_LearningProgres_SubjectId",
                table: "LearningProgres",
                column: "SubjectId");

            migrationBuilder.CreateIndex(
                name: "IX_LearningProgres_UserId",
                table: "LearningProgres",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_MakeQuestion_SubjectDetailId",
                table: "MakeQuestion",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Practice_SubjectDetailId",
                table: "Practice",
                column: "SubjectDetailId");
